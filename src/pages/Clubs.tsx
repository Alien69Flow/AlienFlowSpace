        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center justify-center w-20 h-20 bg-alien-gold/20 rounded-full mb-6 border-2 border-alien-gold/40 backdrop-blur-md">
              <img src="/lovable-uploads/ClubLogo.png" alt="Clubs Official Logo" className="h-12 w-12 object-contain" />
            </div>
            <h1 className="text-4xl md:text-5xl font-bold mb-6 font-nasalization text-glow text-alien-green">
              Clubs
            </h1>
            <p className="text-xl max-w-3xl mx-auto font-[Exo] leading-relaxed text-alien-gold">
          ...
          {/* Featured Clubs */}
          <div className="mb-16">
            <h2 className="text-3xl font-bold mb-8 font-nasalization text-center text-glow text-alien-green">
              Featured Clubs
            </h2>
            <div className="grid grid-cols-1 gap-6 max-w-7xl mx-auto">
              {[...featuredClubs].sort((a, b) => a.name.localeCompare(b.name)).map((club, index) => <FeaturedClubCard key={index} club={club} />)}
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            <div className="lg:col-span-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {allClubs.map((club, index) => <div key={`all-${index}`} className={`${club.bgColor} p-6 rounded-xl backdrop-blur-md overflow-hidden relative group hover:transform hover:scale-[1.02] transition-all duration-300 border border-alien-gold/20 hover:border-alien-gold/40`}>
                    <div className="absolute inset-0 bg-gradient-to-b from-transparent via-alien-space-dark/60 to-alien-space-dark/90 z-0"></div>
            ...
            <div className="space-y-8">
              ...
              <div>
                ...
                <div className="space-y-4">
                  {upcomingEvents.map((event, index) => <div key={index} className="bg-alien-space-dark/80 p-6 rounded-xl backdrop-blur-md border border-alien-gold/30 hover:border-alien-gold/50 transition-all duration-300">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
            ...
            value: '142',
            label: 'Countries'
          }].map((stat, index) => <div key={index} className="bg-alien-space-dark/80 p-8 rounded-xl text-center backdrop-blur-md border border-alien-gold/30 hover:border-alien-gold/50 transition-all duration-300 hover:transform hover:scale-105">
          ...
          <div className="text-center">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-8 gap-4">
              {partners.map((partner, index) => <a key={index} href={partner.url} target="_blank" rel="noopener noreferrer" className="bg-alien-space-dark/80 backdrop-blur-md rounded-xl p-4 border border-alien-gold/30 hover:border-alien-gold/60 transition-all duration-300 hover:transform hover:scale-105 group">
                  <div className="text-center">
                    {partner.logo && <img src={partner.logo} alt={`${partner.name} logo`} className="h-8 w-8 object-contain mx-auto mb-2 group-hover:scale-110 transition-transform" />}
